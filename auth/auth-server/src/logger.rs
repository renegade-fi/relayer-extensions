...
//! ```
//!
//! - **Task** is a closed enum of operations the auth-server performs. New
...
//!   field name `subject` for naming WHICH thing the log line is about (route,
//!   leg, key id) — that keeps dashboards aggregable across call sites that
//!   share a task.
