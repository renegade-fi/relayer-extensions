...
pub struct Cli {
    ...
    /// The URL of the AWS SQS queue for relayer messages
    #[clap(long, env = "RELAYER_SQS_QUEUE_URL")]
    pub relayer_sqs_queue_url: String,
    /// The URL of the AWS SQS queue for onchain events
    #[clap(long, env = "ONCHAIN_EVENTS_SQS_QUEUE_URL")]
    pub onchain_events_sqs_queue_url: String,
    /// The AWS region in which the SQS queues are located
