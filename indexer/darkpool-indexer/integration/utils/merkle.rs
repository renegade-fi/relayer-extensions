...
///
/// Takes the commitment and returns the sibling path used to hash the
...
pub async fn find_commitment(
    ...
    let (data, log) = logs.last().ok_or(eyre!("no logs found for MerkleInsertion"))?;
