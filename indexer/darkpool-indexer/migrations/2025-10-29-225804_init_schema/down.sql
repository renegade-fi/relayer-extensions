-- Drop all tables and types in the initial schema
...
DROP TABLE IF EXISTS "last_indexed_nullifier_block";
DROP TABLE IF EXISTS "last_indexed_recovery_id_block";
DROP TABLE IF EXISTS "last_indexed_public_intent_update_block";
